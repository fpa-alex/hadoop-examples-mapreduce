...
public class DistrictWithMostTrees {
    public static void main(String[] args) throws Exception {
        ...
        Job job = Job.getInstance(conf, "districtwithmosttrees");
        job.setJarByClass(DistrictWithMostTrees.class);
        job.setMapperClass(DistrictWithMostTreesMapper.class);
        job.setCombinerClass(DistrictWithMostTreesReducer.class);
        job.setReducerClass(DistrictWithMostTreesReducer.class);
